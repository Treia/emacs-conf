...
#+BEGIN_SRC emacs-lisp
  (eval-and-compile
    ...
    (dolist (dir (list my/cache-dir (expand-file-name "elpa" my/package-dir)))
...
*** Generated files
No backups and autosaves or lockfiles
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  (setq-default abbrev-file-name (concat my/local-dir "abbrev.el"))
#+END_SRC
...
*** Indentation
I need 4 spaces wide tabs in C to follow my school's guideline.
Using spaces otherwise
#+BEGIN_SRC emacs-lisp
