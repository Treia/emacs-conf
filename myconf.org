...
*** Tools
**** Counsel-dash
Look up dash documentation through counsel
#+BEGIN_SRC emacs-lisp
(use-package counsel-dash
  ...
  (setq counsel-dash-docsets-path (concat my/cache-dir "docsets")))
#+END_SRC
**** Dired
***** Dired
...
**** Smartparens
Automatically close delimiters and blocks
#+BEGIN_SRC emacs-lisp
...
#+BEGIN_SRC emacs-lisp
  ...
  (general-define-key
   ...
   "jb"           '(dumb-jump-back :which-key "Back")
   "jD"           '(dumb-jump-go-other-window "Definition in other window")
