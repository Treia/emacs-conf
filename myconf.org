...
#+BEGIN_SRC emacs-lisp
  (custom-theme-set-faces
    'doom-peacock
    `(org-level-1 ((t (:height 1.0 :weight bold   :slant normal :foreground "#ff5d38" :background "#282725" :underline nil :box (:line-width 4 :color "#282725" :style nil)))))
    `(org-level-2 ((t (:height 1.0 :weight bold   :slant normal :foreground "#cb4b16" :background "#282725" :underline nil :box (:line-width 4 :color "#282725" :style nil)))))
    `(org-level-3 ((t (:height 1.0 :weight normal :slant normal :foreground "#bcd42a" :underline nil))))
    `(org-level-4 ((t (:height 1.0 :weight normal :slant normal :foreground "#98be65" :underline nil))))
    `(org-level-5 ((t (:height 1.0 :weight normal :slant normal :foreground "#26a6a6" :underline nil))))
    `(org-level-6 ((t (:height 1.0 :weight normal :slant normal :foreground "#2257a0" :underline nil))))
    `(org-level-7 ((t (:height 1.0 :weight normal :slant normal :foreground "#c678dd" :underline nil))))
    `(org-level-8 ((t (:height 1.0 :weight normal :slant normal :foreground "#a9a1e1" :underline nil))))
    `(avy-lead-face ((t (:foreground "#cb4b16"))))
    `(avy-lead-face-0 ((t (:foreground "#2257a0"))))
    `(avy-lead-face-1 ((t (:foreground "#98be65"))))
    `(avy-lead-face-2 ((t (:foreground "#bcd42a"))))
  ...
  (custom-set-faces
   '(evil-goggles-delete-face           ((t (:foreground "#cb4b16"))))
   '(evil-goggles-paste-face            ((t (:foreground "#98be65"))))
   '(evil-goggles-yank-face             ((t (:foreground "#51afef"))))
   '(evil-goggles-undo-redo-remove-face ((t (:foreground "#cb4b16"))))
  ...
  (custom-set-faces
    '(whitespace-tab ((t (:foregound "#2e2e2e" :background nil)))))
#+END_SRC
*** Adjust fringe
#+BEGIN_SRC emacs-lisp
  (fringe-mode '(12 . 12))
